...
soil_stats_simple <- function(soildat, var1, var2)
{
  correl <- cor(x=soildat$var1, y = soildat$var2)
  return(paste(var1, "x", var2, "=", correl))
}
soil_stats_simple(soildat, var1 = soildat$Po, var2 = soildat$EOC)
