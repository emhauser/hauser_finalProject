...
SoilSummDat$Po <- data_fill(PoFra)  #These use 2 datasets from import above to make a new dataframe with interpolated values. There should be a column for each set of values in the dataframe. This tests that the data_fill function works correctly.
...
if(testStats3 > correlRangeMin && testStats3 < correlRangeMax)
{
  print("passed")
}else
{
