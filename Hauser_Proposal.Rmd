...
```{r, echo = F, fig.cap="Figure 1. A) Image of a hardwood forest soil pit sampled at the Calhoun Critical Zone Observatory. B) A similarly sampled soil pit located in a pine forest at Calhoun.", out.height="50%", out.width="50%"}
knitr::include_graphics("https://nicholas.duke.edu/cczo/soilpits/R2H1-PROFILE-PA200226.JPG", dpi=100)
knitr::include_graphics("https://nicholas.duke.edu/cczo/soilpits/R2P1-PROFILE-PA200224.JPG", dpi=100)
```
